(() => {
  ...
  function publicationBrandMeta(label=''){
    ...
    const map={
      ...
      'gmail': {src:'data:image/png;base64,', cls:'is-gmail'},
      'email': {src:'data:image/png;base64,', cls:'is-email'},
      'orcid': {src:favicon('orcid.org'), cls:'is-orcid'},
      'pust profile': {src:favicon('pust.ac.bd'), cls:'is-pust'},
      'ru profile': {src:'assets/academic/journals/ijss/ru-logo.webp', cls:'is-university is-ru'},
  ...
  function techBrandIcon(item){
    ...
    const customAssets={
      ...
      'rstudio':'assets/academic/logos/vendor/rstudio.svg',
  ...
  function home(){
          ...
          <div class="hero-grid hero-grid-premium">
            <div class="hero-copy">
              ...
              <div class="hero-impact" aria-label="Research profile highlights">
                ...
                <div class="impact-chip"><strong>33</strong><span>Peer Reviews</span></div>
    ...
    <section class="section"><div class="container">
      ...
      <div class="grid grid-4 service-grid-v3"><article class="card metric metric-card"><strong>33</strong><span>Completed invited reviews</span></article><article class="card editorial-card"><h3>PLOS ONE</h3><p>25 completed reviews</p></article><article class="card editorial-card"><h3>Biomedical Signal Processing and Control</h3><p>7 completed reviews</p><a class="credential-inline-link" href="gallery.html#bspc-reviewing-certificate-2026">View reviewing certificate →</a></article><article class="card editorial-card"><h3>Engineering Applications of Artificial Intelligence</h3><p>1 completed review</p><a class="credential-inline-link" href="gallery.html#eaai-reviewing-certificate-2026">View reviewing certificate →</a></article></div>
    </div></section>
  ...
  function datasetOutputCard(p){
    ...
    return `<article class="card output-card editorial-card dataset-output-card" id="output-${esc(id)}" data-output-bucket="published" data-output-kind="dataset">
      ...
      <div class="dataset-impact-row">
        ...
        <div class="dataset-impact-brands" aria-label="Dataset impact sources">
  ...
  function profile(){
    const engagementEvidence=(D.engagements||[]).filter(e=>e.evidenceAsset);
    return `${pageHero('Profile','Academic identity, communication, working style and engagement.')}
  ...
  function languages(){const lp=D.languageProfile||{};return `${pageHero('Languages & Academic Communication','Native Bangla proficiency, English-medium university education, and evidence-backed scholarly communication across research, conferences and peer review.')}
    ...
    <section class="section alt"><div class="container">
      ...
      <div class="language-practice-strip">
        ...
        <div><span class="practice-icon">${uiIcon('review')}</span><strong>Peer review</strong><p>Critical reading and written reviewer feedback across 33 completed invited reviews.</p></div>
  ...
  function featuredMentorSummaryCard(x){
    ...
    const profileLinks=[...(x.email?[{label:'Email',url:`mailto:${x.email}`}]:[]),...(x.links||[])];
    return `<section class="section network-featured-summary"><div class="container">
      <article class="network-premium-card">
        <div class="network-premium-accent" aria-hidden="true"></div>
        <div class="network-premium-top">
          <div class="network-premium-photo">${x.portrait?`<img src="${esc(x.portrait)}" alt="${esc(x.name||'Academic mentor')} portrait" loading="eager" decoding="async">`:''}</div>
          <div class="network-premium-identity">
            <div class="network-premium-eyebrow"><span class="section-kicker">Featured Academic Mentor</span><span class="network-featured-status">Primary Research Supervisor</span></div>
            <h2>${esc(x.name||'')}</h2>
            ${x.headline?`<p class="network-premium-headline">${esc(x.headline)}</p>`:''}
            ${x.affiliation?`<p class="network-premium-affiliation">${esc(x.affiliation)}</p>`:''}
            <div class="network-premium-relationship">
              <div><span>Academic relationship</span><strong>${esc(x.relationship?.title||'Research supervision')}</strong></div>
              <p>B.Sc. Field Survey <i>→</i> B.Sc. Statistical Project <i>→</i> M.S. Project <i>→</i> Continuing research collaboration</p>
            </div>
            <a class="btn primary network-profile-cta" href="network-shamim-reza.html">View Full Profile <span aria-hidden="true">→</span></a>
          </div>
          <aside class="network-premium-leadership">
            <span class="section-kicker">Academic Leadership</span>
            <div class="network-premium-rolelist">${(x.currentPositions||[]).slice(0,4).map((role,i)=>`<div><span>0${i+1}</span><p>${esc(role)}</p></div>`).join('')}</div>
          </aside>
        </div>
        <div class="network-premium-profiles" aria-label="Academic and professional profiles">
          <div class="network-premium-profiles-label"><span class="section-kicker">Academic identity</span><strong>Profiles & contact</strong></div>
          <div class="network-premium-profilelinks">${profileLinks.map(mentorProfileLink).join('')}</div>
        </div>
        <footer class="network-premium-record">
          <div class="network-premium-record-label"><span class="section-kicker">Shared Scholarly Record</span><strong>Research collaboration with Razu</strong></div>
          <div class="network-premium-stats">${stats.map(s=>`<div><strong>${esc(s.value)}</strong><span>${esc(s.label)}</span></div>`).join('')}</div>
        </footer>
      </article>
    </div></section>`;
  }
    ...
    return `${pageHero('Academic Network Profile','A detailed academic profile and relationship context within this research network.')}
      <section class="section network-profile-page">
        <div class="container">
          ...
          <div class="network-profile-linkrail">
            ...
            <div class="network-profile-links network-profile-links-premium">
              ...
              ${x.additionalEmail?mentorProfileLink({label:'Personal Email',url:`mailto:${x.additionalEmail}`}):''}
          ...
          <section class="network-profile-section" id="overview">
            ...
            <div class="network-overview-grid">
              ...
              <article class="network-profile-panel">
                <h3>Relationship with ${highlightRazuName('Razu')}</h3>
                <p>${highlightRazuName(x.relationship?.detail||'')}</p>
                <div class="network-supervision-path">${supervisionPath.map((step,i)=>`<div><span>${String(i+1).padStart(2,'0')}</span><strong>${esc(step)}</strong></div>`).join('')}</div>
              </article>
            </div>
          </section>

          <section class="network-profile-section" id="academic-profile">
            <div class="network-profile-section-head"><div><span class="section-kicker">Academic profile</span><h2>Education & appointments</h2></div></div>
            <div class="network-overview-grid">
              <article class="network-profile-panel">
                <h3>Education</h3>
          ...
          <div class="network-profile-footer-actions"><a class="btn ghost" href="network.html">← Back to Network</a><a class="btn primary" href="#page-content">Back to Top ↑</a></div>
        </div>
      </section>`;
  }
  ...
  function network(){
    ...
    const groups=[...new Set(people.map(x=>x.group))];
      ...
      <section class="section network-section"><div class="container">
        ${groups.map((g,idx)=>`<div class="network-group ${idx===0?'network-group-featured':''}">
          <div class="network-group-head">
            ...
            <div class="network-group-count">${people.filter(x=>x.group===g).length} people</div>
          </div>
          <div class="network-board">${people.filter(x=>x.group===g).map(networkPersonCard).join('')}</div>
        </div>`).join('')}
      </div></section>`;
  }
  ...
  function dashboard(){
    ...
    return `${pageHero('Research & Impact Dashboard','Interactive academic metrics with source-aware interpretation.')}<section class="section"><div class="container">${sectionHead('Verified metrics','Current scholarly indicators','ResearchGate and Mendeley Data indicators are shown with source and verification date.')}<div class="grid grid-4">${(D.impactMetrics||[]).map(m=>`<article class="card metric dashboard-metric-card"><strong class="dashboard-metric-value">${esc(m.value)}</strong><span class="dashboard-metric-label">${esc(m.label)}</span>${dashboardMetricSource(m)}${m.source==='Mendeley Data'&&['Usage','Views','Downloads'].includes(m.label)?`<small class="dashboard-impact-system"><span>Impact system</span><strong>PlumX Metrics</strong> · Usage category</small>`:''}</article>`).join('')}</div><aside class="dashboard-impact-provenance"><div><span class="section-kicker">Dataset impact provenance</span><strong>Mendeley Data + PlumX Metrics</strong></div><p>Usage, Views and Downloads are attributed to Mendeley Data. PlumX is shown as the broader impact system for dataset-level engagement and alternative-impact signals.</p><div class="dashboard-impact-links dashboard-impact-brand-links">
          ${publicationBrandLink({label:'Mendeley Data',url:'https://data.mendeley.com/datasets/fn6yhzjz83/2'})}
          ${publicationBrandLink({label:'PlumX Metrics',url:'https://plu.mx/plum/a/?doi=10.17632/fn6yhzjz83&theme=plum-bigben-theme'})}
        </div></aside></div></section><section class="section alt"><div class="container">${sectionHead('Portfolio analytics','Research distribution')}<div class="grid grid-3"><article class="card"><h3>Publication status</h3><p>${publishedArticles} published articles · ${publishedDatasets} published dataset · ${accepted} accepted/forthcoming · ${editorial} in the editorial process${preparing?` · ${preparing} in preparation`:''}.</p></article><article class="card"><h3>Conference record</h3><p>8 contributions · 3 presentations · 1 JSR Award.</p></article><article class="card"><h3>Scholarly service</h3><p>33 completed invited reviews across three journals.</p></article></div></div></section>`;
  }
