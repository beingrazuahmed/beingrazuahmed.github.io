window.PORTFOLIO_DATA = {
  ...
  gallery: [
    { id: "10-minute-school-affiliate-evidence", title: "10 Minute School — Affiliate Partner", category: "Professional Development", evidenceType: "Role Evidence", date: "December 2020–Present", issuer: "10 Minute School", caption: "Welcome graphic identifying Md. Razu Ahmed as an Affiliate Partner of 10 Minute School.", asset: "assets/gallery/10-minute-school-affiliate-partner-evidence.jpg", href: "assets/gallery/10-minute-school-affiliate-partner-evidence.jpg", related: "profile.html", verified: true, sourceFile: "User-provided 10 Minute School role evidence" },
    ...
    { id: "peer-review-recognition-summary", title: "Peer Review Recognition", category: "Scholarly Service", caption: "Verified reviewing activity across PLOS ONE, Biomedical Signal Processing and Control, and Engineering Applications of Artificial Intelligence.", asset: "assets/gallery/eaai-reviewing-certificate-2026.webp", href: "gallery.html#eaai-reviewing-certificate-2026", related: "experience.html", verified: false, sourceFile: "Certificate_EAAI_Recognised(1).pdf" }
  ],
